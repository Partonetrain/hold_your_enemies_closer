...
| Frost Protection | Enchanting table, loot, trading       | Goes on armor. Reduces freezing damage and freezing time. Having less than or equal to 50% freezing time allows you to walk on Powdered Snow.                                                                   | 1         | Frost                   |
...
- The Autosmelt logic intentionally reuses the `minecraft:smelts_loot` enchantment, making Fire Aspect also able to smelt block loot.
- Frost Walker also now allows entities to walk on Powdered Snow.
- There is a forge project in the repo, but it is currently unused and does nothing, I left it in case I or others want to make a Forge release